          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 text-gray-600">
                <tr>
                  <th className="text-left px-6 py-4 font-semibold whitespace-nowrap">Salesman Name</th>
                  <th className="text-left px-6 py-4 font-semibold whitespace-nowrap">Primary Route</th>
                  <th className="text-center px-6 py-4 font-semibold whitespace-nowrap">Visits (Month)</th>
                  <th className="text-right px-6 py-4 font-semibold whitespace-nowrap">Collections (Month)</th>
                  <th className="text-center px-6 py-4 font-semibold whitespace-nowrap">Pending Stores</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {performance.map(p => (
                  <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-600 whitespace-nowrap">{p.route_name}</td>
                    <td className="px-6 py-4 text-center font-semibold text-brand-600 whitespace-nowrap">{p.monthVisits}</td>
                    <td className="px-6 py-4 text-right font-semibold text-amber-600 whitespace-nowrap">₹{p.monthCollections.toLocaleString('en-IN')}</td>
